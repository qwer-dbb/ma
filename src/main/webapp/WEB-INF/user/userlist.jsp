...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/user/list.do">
                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList}" varStatus="status">
					<tr>
						...
						<span><a class="viewUser" href="${pageContext.request.contextPath }/user/getUserById.do?id=${user.id}"><img src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
						<span><a class="modifyUser" href="${pageContext.request.contextPath }/user/modify.do?id=${user.id}"><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
						<span>
